...
def achievementRank(rankType):
    if rankType == 1:
        ...
        incomeRank += '截止{} 前100用户收入总额：{}元'.format(strftime('%m-%d %H:%M', localtime(time())),
    ...
    if rankType == 2:
        ...
        payRank += '截止{} 前100用户消费总额：{}元'.format(strftime('%m-%d %H:%M', localtime(time())),
