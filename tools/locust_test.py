...
class InterfaceConcurrency(TaskSet):
    ...
    def on_banban_consume_single(self):
        ...
        url = "https://192.168.11.46/pay/create?package=com.imbb.banban.android"
        payload = 'platform=available&type=banban-consume&money=9600&params={"consume_type":"gift_combine","rid":200093221,"combine_id":1,"combine_type":1,"pay_receptor":{"gift_id":1406,"gift_num":1,"uid":"105000355"},"pay_gs":{"gift_id":1407,"gift_num":1,"uid":"105000355"},"useCoin":-1}'
    ...
    def panelGift(self):
        ...
        url = "https://192.168.11.46/pay/create?package=com.imbb.banban.android"
        payload = 'platform=available&type=package&money=999900&params={"room_ticket":1,"price":999900,"rid":200093620,"uids":"105000355","giftId":21,"giftNum":1,"version":2,"gift_type":"normal","useCoin":-1}'
        res = self.client.post(url, data=payload, headers=headers, verify=False)
        if res.status_code == 200:
            print(res.json())
        else:
